#     cb_test_env_bat2sh.sed - A sed script for converting the
#            conda_test_env_vars.bat script generated by conda-build to an
#            equivalent bash script suitable for running in a conda-forge
#            m2-bash environment 
